...
namespace Placement
{
    public class cGrid
    {
        ...
        public class Block
        {
            ...
            public Block(cGrid ParentGrid, int xKey, int yKey, Vector3 CenterPosition, float cellSize)
            {
                this.UpdateBlock(ParentGrid, xKey, yKey, CenterPosition, cellSize);
            }

            public void UpdateBlock(cGrid ParentGrid, int xKey, int yKey, Vector3 CenterPosition, float cellSize)
            {
        ...
        public class GridBackground
        {
            ...
            private cGrid parent;

            public Image BackGroundImage { get { return image; } }
            public float Width { get { return width; } }
            public float Height { get { return height; } }

            public GridBackground(Image image, float width, float height, Vector3 originPosition, cGrid parent)
            {
                this.image = image;
                this.width = width;
                this.height = height;
            ...
            {
                Transform _t = LiveGrid.Instantiate(GameObject.CreatePrimitive(PrimitiveType.Cube)).transform;
        ...
        //constructor/s
        public cGrid(int width, int height, float cellSize, Vector3 originPosition, Image MapBackgroundImage, LiveGrid parent)
        {
            this.width_x = width;
